...
public class enemy2 extends AnimatedActor
{
    ...
    private void setSprites(){
        if(frames[0] == null){ //put this on so we dont reload images every time we make an enemy
            ...
            frames[0] = new GreenfootImage("mage1R.png");
            frames[1] = new GreenfootImage("mage1R.png");
            frames[2] = new GreenfootImage("mage1R.png");
            frames[3] = new GreenfootImage("mage1R.png");
            frames[4] = new GreenfootImage("mage1R.png");
            
            /**load left facing frames*/
            frames[0+5] = new GreenfootImage("mage1L.png");
            frames[1+5] = new GreenfootImage("mage1L.png");
            frames[2+5] = new GreenfootImage("mage1L.png");
            frames[3+5] = new GreenfootImage("mage1L.png");
            frames[4+5] = new GreenfootImage("mage1L.png");
        }
    }
